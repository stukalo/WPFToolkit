...
namespace Microsoft.Windows.Shell
{
	public class SystemParameters2 : INotifyPropertyChanged
	{
		...
		private void _InitializeCaptionButtonLocation()
		{
			...
			Rect logical = DpiHelper.DeviceRectToLogical(new Rect((double)(rECT.Left - windowRect.Width - windowRect.Left), (double)(rECT.Top - windowRect.Top), (double)rECT.Width, (double)rECT.Height));
			this.WindowCaptionButtonsLocation = logical;
		}
